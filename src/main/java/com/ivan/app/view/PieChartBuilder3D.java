 ...
 * @author ivan
 */
public class PieChartBuilder3D implements IPieChart3DBuilder  {
    ...
    @Override
    public IPieChart3DBuilder setStartAngle(int i) {
        return this;
    }

    @Override
    public IPieChart3DBuilder setForeground(float f) {
        return this;
    }
